...
The repository's coding standards are maintained in the [Copilot instructions](.github/copilot-instructions.md) and the focused [instruction files](.github/instructions/). In particular:

- Comments explain intent and non-obvious decisions, not code mechanics.
...
- TypeScript formatting uses four-space indentation, single quotes, semicolons, and trailing commas in multiline expressions; ESLint enforces the supported formatting rules.
